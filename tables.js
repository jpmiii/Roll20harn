...
var default_abilities = {
    "Atk":`!attack @{selected|token_id} ?{aim zone|mid|high|low${state.Harn.config.house_rule_additional_target_locations?"|arms|legs|torso|head|neck|skull|abdomen|face|thorax|shoulder|hip|thigh|knee|calf|foot|upper_arm|elbow|forearm|hand|groin":""}} ?{Aspect|H|B|E|P|F} ?{Attack Type|melee|missle} ?{Mod|0} @{target|token_id} %{@{character_name}|helper-Weapons}`,
