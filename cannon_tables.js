/**
 * Tables for which alternate house rule tables exist.
 */

 const cannon_tables = {
    default_abilities: {
        "Atk":`!attack @{selected|token_id} ?{aim zone|mid|high|low} ?{Aspect|H|B|E|P|F} ?{Attack Type|melee|missle} ?{Mod|0} @{target|token_id} %{@{character_name}|helper-Weapons}`,
